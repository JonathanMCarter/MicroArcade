...
//    {
//        transform = targets[0] as Transform;          // Assigns the transform componenet to the T Variable
...
//        initPos = transform.localPosition;      // Setting the Initial Position of the Transform to what the current local position is
//        initRot = transform.localEulerAngles;   // Setting the Initial Rotation of the Transform to what the current local rotation is
//        initScale = transform.localScale;       // Setting the Initial Scale of the Transform to what the current local scale is
...
//        * Kinda my bad, should act like the normal transform on rotations now xD Rotation is awkward when its split up into its x,y,z values...
//        */

//        transform.localEulerAngles = new Vector3(rotX.floatValue, rotY.floatValue, rotZ.floatValue);
...
//                if (posChange)
//                {
//                    SelectedTransforms[i].localPosition = ApplyPositionWhatChange(SelectedTransforms[i].localPosition, initPos, transform.localPosition);
//                }
//                if (rotChange)
//                {
//                    SelectedTransforms[i].localEulerAngles = ApplyRotationWhatChange(SelectedTransforms[i].localEulerAngles, initRot, transform.localEulerAngles);
//                }
//                if (scaleChange)
//                {
//                    SelectedTransforms[i].localScale = ApplyScaleWhatChange(SelectedTransforms[i].localScale, initScale, transform.localScale);
//                }
//            }
//        }

//        // Apply the changes and update the editor
...
//        {
//            ToApply.x = transform.localPosition.x;
//        }

//        if (!Mathf.Approximately(Init.y, Change.y))
//        {
//            ToApply.y = transform.localPosition.y;
//        }

//        if (!Mathf.Approximately(Init.z, Change.z))
//        {
//            ToApply.z = transform.localPosition.z;
//        }
...
//        if (!Mathf.Approximately(Init.x, Change.x))
//        {
//            ToApply.x = transform.localEulerAngles.x;
//        }
//        else
//        {
//            ToApply.x = Init.x;
...
//        if (!Mathf.Approximately(Init.y, Change.y))
//        {
//            ToApply.y = transform.localEulerAngles.y;
//        }
//        else
//        {
//            ToApply.y = Init.y;
...
//        if (!Mathf.Approximately(Init.z, Change.z))
//        {
//            ToApply.z = transform.localEulerAngles.z;
//        }
//        else
//        {
//            ToApply.z = Init.z;
...
//        if (!Mathf.Approximately(Init.x, Change.x))
//        {
//            ToApply.x = transform.localScale.x;
//        }

//        if (!Mathf.Approximately(Init.y, Change.y))
//        {
//            ToApply.y = transform.localScale.y;
//        }

//        if (!Mathf.Approximately(Init.z, Change.z))
//        {
//            ToApply.z = transform.localScale.z;
//        }
